  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      <header className="mb-5">
        ...
        <p className="text-sm text-fg-muted">How the shop is doing, and what's driving it. Read-only.</p>
      </header>
      ...
      {needsDates && <p className="text-sm text-fg-muted">Pick a start and end date for the custom range.</p>}
      {isError && <ErrorText>{error.message}</ErrorText>}
      {!needsDates && isLoading && <p className="text-sm text-fg-muted">Loading…</p>}
